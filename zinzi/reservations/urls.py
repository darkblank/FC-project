...
from reservations.views.payments import PaymentCreateView, PaymentDetailView, PaymentCancelView
...
urlpatterns = [
    ...
    url(r'^(?P<imp_uid>imp_\d+)/paymentcancel', PaymentCancelView.as_view(), name='payment-cancel'),
